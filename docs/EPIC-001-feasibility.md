...
| **STORY-1-5-1** | **HermesAdapter 安装配置完整消费** | **SPEC-1-5** | **P0** | **✅ implemented** |
| **STORY-1-5-2** | **依赖检查与验证门禁** | **SPEC-1-5** | **P0** | **✅ implemented** |
| **STORY-1-5-3** | **端到端集成测试** | **SPEC-1-5** | **P0** | **✅ implemented** |
| **STORY-1-5-4** | **多 Agent 安装与自动检测** | **SPEC-1-5** | **P1** | **✅ implemented** |
| **STORY-1-5-5** | **卸载增强与快照回滚测试** | **SPEC-1-5** | **P1** | **✅ implemented** |
