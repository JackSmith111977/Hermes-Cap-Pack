...
description: Songwriting craft, AI music generation prompts (Suno focus), parody/adaptat...
triggers:
- writing a song
- song lyrics
- music prompt
...
> 🔍 **## 3. Emotional Arc** moved to [references/detailed.md](references/detailed.md)
